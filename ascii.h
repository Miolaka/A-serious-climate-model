/*--------------------------------------------------------------------
 * $Id: ascii.h,v 1.1.1.1 2011/01/14 10:38:49 bernhard Exp $
 * 
...
#define NOT_A_RECTANGULAR_MATRIX -5  
...
int ASCII_file2xy2D     (char *filename, int *nx, int *ny, double **x, double ***y);
